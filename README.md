...
* To obtain the results of 2sUnet and Unet, run the scripts test_unet_DA.py and test_2sunet_DA.py respectively (example: python test_unet_DA.py). The results will get saved in ``testouts/``
