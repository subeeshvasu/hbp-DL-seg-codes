...
from src.networks import UNetSharedSeg2Out
...
test_settings = {"data_test":
                    ...
                    "suffix":".png"},
                 "save_dir": "./testouts/UNetDA",
                 "save_suffix": ".jpg",
                 "weight_dir": "./weights/UNetDA",
...
net_seg     = UNetSharedSeg2Out(unet_config).to(device)
...
for i_val, (images_val, image_name) in enumerate(data_loader_test):
    ...
    with torch.no_grad():
        ...
        prediction = predict_in_blocks_UNetDA2Out(net_seg, images_val, in_shape = [512,512], block_shape = [324, 324], 
                                        output_function=net_seg.forward, image_format="NHWC", device = device)
